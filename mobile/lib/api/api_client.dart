...
class ApiClient {
  ...
  /// نفس حلّ العنوان الذي تستعمله كل نداءات JSON هنا، لكن بلا نداء شبكة —
  /// لوجهة تُفتَح في متصفّح خارجي (`url_launcher`) لا تُقرَأ استجابتها JSON.
  Uri buildUrl(String path) => _uri(path);
