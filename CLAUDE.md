...
**البحث لا يزال عاماً وليس ما تبقّى من الخطوة.** الترقيم/التبويبات، التبريكات ومراجعتها،
الإعلان والتذكير، الستوريات، والواجهات (`web/` و`mobile/`) **لم تُحدَّث بعد** — لا تزال
تفترض عرساً واحداً بحقول عرس ثابتة (تبريكة «مبارك الفرح» افتراضية، تفاعلات `coffee`
