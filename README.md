...
المستخدم المسجَّلة، بمحاولة إعادة واحدة محدودة عند 429. ⚠️ **هذا جانب الخادم فقط**: لا مستخدم
حقيقي يصله شيء بعد حتى تصل دفعة ٦ (Service Worker، طلب الإذن، شاشة الإيقاف) — بلا Service
Worker لا شيء يستقبل الدفعة في المتصفح، مهما نجح الخادم في إرسالها. بلا زوج VAPID مضبوط على
الخادم يبقى كل شيء آخر كما هو تماماً: الصفّ يُكتب دائماً، والاشتراك وحده يُرفض بـ400 عربي.
