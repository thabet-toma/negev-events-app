...
function buildNoticeText() {
  ...
  return [
    ...
    'المدير العام للمنصّة وحده يستطيع الاطلاع على إحصاءات مجمَّعة — عدد لكل نوع حدث. ' +
      'وهو وحده أيضاً من يستطيع الاطلاع على ما سُجِّل من هذه الأفعال عن شخص بعينه، ' +
      'وذلك فقط لتلبية طلب اطلاع أو طلب محو تقدَّم به صاحب البيانات نفسه — لا لأي غرض آخر. ' +
      'وحتى في هذه الحالة لا يظهر أبداً أيّ ذكر لمناسبة بعينها فتحها ذلك الشخص — ' +
      'هذا لا يُسجَّل عن أحد أصلاً، كما ورد أعلاه. ولا يملك مدير بلدة أي صلاحية هنا.',
    '',
    'سجل الوصول للخادم',
